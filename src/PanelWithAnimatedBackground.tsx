...
  },
  en: {
    // (Aquí va la versión completa en inglés de la Versión 14)
    // ... (Omitida para brevedad en esta respuesta)
    // Si necesitas que la ponga completa, por favor avísame.
    // Asumo que el objeto `translations` de tu V14 es correcto y lo he incluido.
    name: 'ENRIQUE DOMÍNGUEZ',
    contact_email: 'Email:',
    contact_phone: 'Phone:',
    contact_linkedin: 'LinkedIn:',
...
  // Estado para el idioma actual (V14)
